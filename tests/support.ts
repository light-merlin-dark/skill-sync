...
export function writeExecutableText(path: string, content: string): void {
...
export function makeFakeProjectsRoot(): {
	homeDir: string;
	projectsRoot: string;
} {
...
export function makeTopLevelSkill(
	projectsRoot: string,
	repoName: string,
	skillName?: string,
): string {
...
export function makeNestedSkill(
	projectsRoot: string,
	repoName: string,
	nestedName: string,
	skillName?: string,
